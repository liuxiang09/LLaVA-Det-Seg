...
def parse_args(args):
    ...
    parser.add_argument("--version", default="/home/hpc/Desktop/LLaVA/checkpoints/llava-v1.5-7b")
    ...
    parser.add_argument("--dataset", default="sem_seg", type=str)
    parser.add_argument("--sample_rates", default="1", type=str)
    parser.add_argument("--sem_seg_data",default="cocostuff||paco_lvis",type=str,)
    ...
    parser.add_argument("--exp_name", default="liux", type=str)
...
def main(args):
    ...
    model.resize_token_embeddings(len(tokenizer))   # 更新tokenizer
    ...
    ds_config = {
        ...
        "zero_optimization": {
            ...
            "overlap_comm": True,
            "reduce_scatter": True,
            "reduce_bucket_size": 2e8,          # 原5e8
            "allgather_bucket_size": 2e8,       # 原5e8
        },
    }
...
def train(
    ...
    for global_step in range(args.steps_per_epoch):
        ...
        if global_step != 0:                        # 避免第一次学习率为0
            curr_lr = scheduler.get_last_lr()       # 获取当前学习率
            if args.local_rank == 0:
